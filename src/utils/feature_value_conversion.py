...
def cut_to_window(input_folder, output_folder, window_size=1.5, overlap=0.8):
...
def combine_feature_files(input_folder):
    files = [os.path.join(input_folder, str(i), "feature_data.csv") for i in range(1, 7)]
